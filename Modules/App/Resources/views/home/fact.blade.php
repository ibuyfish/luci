<section class="mt-8" style="background-image:url({{asset('assets/images/home/ask_bg.png')}})">
    <div class="lg:px-[133px]">
        <div class="grid lg:grid-cols-7 relative">
            ...
            <div class="absolute top-[40px] 2xl:top-[130px] xl:w-2/3 2xl:w-1/2">
                <h1 class="text-[50px] font-bold text-home_primary">Trải qua hơn 5 năm thành lập </h1>
                <p class="text-black text-[24px]">Công ty Cổ phần Luci là Công ty công nghệ tiên phong nghiên cứu và
                    phát
            ...
            <div class="lg:col-span-4 -mt-[80px]">
...
<section>
    <div class="bg-white mx-[130px] rounded-xl p-[39px] xl:-mt-[250px] 2xl:-mt-[330px] relative z-10">
        <div class="relative">
            ...
            <div class="dropDownContainer">
                <div class="grid grid-cols-2 gap-1 py-8">
                    <div class="">
                        <h1 class="text-[24px] font-bold text-black">Hệ sinh thái Luci Cloud</h1>
                        <p class="text-[20px] font-medium text-[#2E2E2E]">
