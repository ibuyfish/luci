<section>
    <div class="container px-[15px] lg:px-0">
        <h1 class="text-[32px] lg:text-[50px] uppercase text-black font-bold">Tìm hiểu các cơ hội việc làm</h1>
...
<section class="mt-[48px] px-[15px] lg:px-0 pb-10">
    <div class="bg-white lg:mx-[130px] rounded-xl p-4 lg:p-[39px] relative z-10">
        <div class="relative">
            ...
            <div class="dropDownContainer">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-[60px] py-8">
