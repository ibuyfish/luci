    ...
    <div class="container grid grid-cols-1 lg:grid-cols-11 py-[110px]">
        <div class="col-span-5">
            ...
            <p class="text-[24px] text-black mt-[69px]">
                Luci đặc biệt chú trọng đến chính sách đãi ngộ, quan tâm đến đời sống của cán bộ nhân viên với phương
                châm tạo cho cán bộ nhân viên có một cuộc sống “đầy đủ về vật chất và phong phú về tinh thần”. Chính
