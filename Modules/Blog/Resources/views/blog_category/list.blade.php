        ...
        <div class="flex-1 p-7">
            ...
            <div class="rounded-lg bg-secondary p-[14px]">
                <div class="mb-5 flex items-center gap-5">
                    <h1 class="text-base">{{ __('dashboard.blog_category.list') }}</h1>
                    ...
                    <div class="w-[120px]">
                        <x-component::button.href href="{{route('admin.blog_category.create')}}"
                            ...
                            <tr>
                                ...
                                <td tabindex="1"
                                    ...
                                    <div
                                        ...
                                        <div
                                            class="text-text py-[10px] text-start text-sm transition hover:text-primary">
                                            <a href="{{route('admin.blog_category.edit',$model->id)}}">
...
<x-component::modal.delete url="{{route('admin.blog_category.delete')}}" />
...
<script>
    $("#table").on("click", ".setTop", function (e) {
        ...
        $.ajax({
            url: `{{route('admin.blog_category.setTop')}}`,
            type: "POST",
    ...
    $("#table").on("click", ".toggleShow", function (e) {
        ...
        var _token = $('meta[name="csrf-token"]').attr("content");
        $.ajax({
            url: `{{route('admin.blog_category.toggleShow')}}`,
            type: "POST",
            data: { _token: _token, id: id },
            success: function (responese) {
                $("#table").load(location.href + " #table");
